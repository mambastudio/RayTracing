...
import raytracing.accel.grid.GridMap;

/**
 *
 * @author user
 */
public class NGrid implements GridMap{
    public NativeInteger        entries;         ///< Voxel map, stored as a contiguous array
    public NativeInteger        ref_ids;   ///< Array of primitive references
    public NativeObject<NCell>  cells; ///< Cells of the structure (nullptr if compressed)
    ...
    public BoundingBox cellbound(NCell cell) {return new BoundingBox(
